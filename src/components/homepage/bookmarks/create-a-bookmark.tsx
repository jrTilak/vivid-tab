      ...
      <DialogContent className="sm:max-w-[425px]">
        <form onSubmit={handleSubmit}>
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {
                defaultValues ? "Edit the bookmark you want to update." : "Enter the name of the bookmark you want to create."
              }
            </DialogDescription>
          </DialogHeader>
          <div className='space-y-2 py-4'>
            <div className="grid gap-4">
              <Input
                ...
                id="name" placeholder='Name' className="col-span-3" />
            </div>
            <div className="grid gap-4">
              <Input
                value={value.url}
                ...
                id="url" placeholder='https://....' className="col-span-3" />
            </div>
          </div>
          <DialogFooter>
            <Button size='sm' className='min-w-32' disabled={value.title.length === 0 || value.url.length === 0} type="submit">Save </Button>
          </DialogFooter>
        </form>
      </DialogContent>
    </Dialog>
