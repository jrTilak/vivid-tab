...
>(
  (
    { className, children, overlayClassName, portalContainer, ...props },
    ref,
  ) => (
    <DialogPortal container={portalContainer}>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "fixed left-[50%] top-[50%] z-50 grid w-full max-sm:max-w-[90vw] translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background/70 backdrop-blur-xl p-6 shadow-lg duration-200 sm:rounded-lg",
          ...
          // slight movement upward when opening
